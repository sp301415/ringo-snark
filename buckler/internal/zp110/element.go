...
const (
	...
	Bits  = 110 // number of bits needed to represent a Uint
...
func (z *Uint) SetInterface(i1 interface{}) (*Uint, error) {
	if i1 == nil {
		return nil, errors.New("can't set zp110.Uint with <nil>")
	}
	...
	default:
		return nil, errors.New("can't set zp110.Uint from type " + reflect.TypeOf(i1).String())
	}
}
...
func (z *Uint) SetBytesCanonical(e []byte) error {
	if len(e) != Bytes {
		return errors.New("invalid zp110.Uint encoding")
	}
	v, err := BigEndian.Element((*[Bytes]byte)(e))
	if err != nil {
		return err
...
var errInvalidEncoding = errors.New("invalid zp110.Uint encoding")
