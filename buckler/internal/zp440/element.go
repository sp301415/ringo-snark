...
const (
	q0 = 1
	q1 = 12148300569940852736
	q2 = 12640430495328671408
	q3 = 17137309074836342590
	q4 = 16981651425345111637
	q5 = 14405505931408296241
	q6 = 38682099262708859
)
...
func init() {
	_modulus.SetString("896d2a11b85c7bc7eaa3522b5fc931ebaaf1ffab338655edd3f3ce63b2c73eaf6bd4904a1496b0a8976f01000000000000000000000001", 16)
}
...
func (z *Uint) SetOne() *Uint {
	z[0] = 18446744073709551140
	z[1] = 9686567852953305087
	z[2] = 15240396326575787910
	z[3] = 14548505031232292721
	z[4] = 14854569894220019769
	z[5] = 5167972069604189997
	z[6] = 34064824660134360
	return z
}
...
func (z *Uint) IsOne() bool {
	return ((z[6] ^ 34064824660134360) | (z[5] ^ 5167972069604189997) | (z[4] ^ 14854569894220019769) | (z[3] ^ 14548505031232292721) | (z[2] ^ 15240396326575787910) | (z[1] ^ 9686567852953305087) | (z[0] ^ 18446744073709551140)) == 0
}
...
func (z *Uint) LexicographicallyLargest() bool {
	...
	_, b = bits.Sub64(_z[1], 6074150284970426368, b)
	_, b = bits.Sub64(_z[2], 6320215247664335704, b)
	_, b = bits.Sub64(_z[3], 17792026574272947103, b)
	_, b = bits.Sub64(_z[4], 17714197749527331626, b)
	_, b = bits.Sub64(_z[5], 16426125002558923928, b)
	_, b = bits.Sub64(_z[6], 19341049631354429, b)
...
var rSquare = Uint{
	7957502951512554555,
	12345321831659416800,
	9520095695786331806,
	5925117002441554476,
	18381966231916359909,
	12912295097051746070,
	25994926958157201,
}
...
func init() {
	_bLegendreExponentUint, _ = new(big.Int).SetString("44b69508dc2e3de3f551a915afe498f5d578ffd599c32af6e9f9e731d9639f57b5ea48250a4b58544bb780800000000000000000000000", 16)
	const sqrtExponentUint = "44b69508dc2e3de3f551a915afe498f5d578ffd599c32af6e9f9e731d9639f57b5ea48250a4b58544bb780"
...
const (
	inversionCorrectionFactorWord0 = 7742376401336194432
	inversionCorrectionFactorWord1 = 185937284114290823
	inversionCorrectionFactorWord2 = 15709758537797783776
	inversionCorrectionFactorWord3 = 387273538271828812
	inversionCorrectionFactorWord4 = 12010647515721412782
	inversionCorrectionFactorWord5 = 7247590188967459210
	inversionCorrectionFactorWord6 = 28354177380316052
	invIterationsN                 = 30
)
