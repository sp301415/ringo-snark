...
func MulBy13(x *Uint) {
	var y = Uint{
		11140730654235289089,
		8268856554948376182,
		12339910357946912832,
		7370115832013430581,
		12038058212546799336,
		747189159355042308,
		35071450803557295,
	}
	x.Mul(x, &y)
...
func (z *Uint) Mul(x, y *Uint) *Uint {
	...
	var u0, u1, u2, u3, u4, u5, u6 uint64
	{
		...
		t5, c0 = bits.Add64(0, c1, c0)
		u6, _ = bits.Add64(u6, 0, c0)
		...
		t5, c0 = bits.Add64(t6, t5, 0)
		t6, _ = bits.Add64(u6, c2, c0)
