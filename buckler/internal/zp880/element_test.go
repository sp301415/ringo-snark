...
func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		if qElement[13] != ^uint64(0) {
			g.element[13] %= (qElement[13] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		a[11], carry = bits.Add64(a[11], qElement[11], carry)
		a[12], carry = bits.Add64(a[12], qElement[12], carry)
		a[13], _ = bits.Add64(a[13], qElement[13], carry)
...
func (z *Uint) matchVeryBigInt(aHi uint64, aInt *big.Int) error {
	var modulus big.Int
	var aIntMod big.Int
	modulus.SetInt64(1)
...
func (z *Uint) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func TestUintInversionApproximation(t *testing.T) {
	var x Uint
	for i := 0; i < 1000; i++ {
		x.MustSetRandom()
...
func TestUintInversionCorrectionFactorFormula(t *testing.T) {
	...
	inversionCorrectionFactor := Uint{
...
func TestUintLinearComb(t *testing.T) {
	var x Uint
	var y Uint
...
func TestUintInversionCorrectionFactor(t *testing.T) {
	...
	if !oneInv.Equal(&one) {
		...
		var facTimesFac Uint
		facTimesFac.Mul(&fac, &Uint{
			inversionCorrectionFactorWord0,
			inversionCorrectionFactorWord1,
			inversionCorrectionFactorWord2,
			inversionCorrectionFactorWord3,
...
func TestUintBigNumNeg(t *testing.T) {
	var a Uint
	aHi := negL(&a, 0)
	if !a.IsZero() || aHi != 0 {
		t.Error("-0 != 0")
...
func TestUintBigNumWMul(t *testing.T) {
	var x Uint
...
func TestUintVeryBigIntConversion(t *testing.T) {
...
func TestUintMontReduce(t *testing.T) {
...
func TestUintMontReduceMultipleOfR(t *testing.T) {
...
func TestUint0Inverse(t *testing.T) {
	var x Uint
	x.Inverse(&x)
	if !x.IsZero() {
		t.Fail()
...
func testLinearComb(t *testing.T, x *Uint, xC int64, y *Uint, yC int64) {
...
func testBigNumWMul(t *testing.T, a *Uint, c int64) {
	var aHi uint64
	var aTimes Uint
...
func (z *Uint) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.toBigInt(i)
...
func (z *Uint) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *Uint, c int64, result *Uint, resultHi uint64) big.Int {
	var xInt big.Int
	x.toBigInt(&xInt)
...
func approximateRef(x *Uint) uint64 {
